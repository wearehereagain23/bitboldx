...
app.post('/done1.html', async (req, res) => {
                                                ...
                                                <tr>
                                                    <td align="left" style="padding:0;Margin:0;width:560px">
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;padding-top:30px;font-size:0">
                                                                    <img src="https://fpwncdgdqbhrkabqbisz.supabase.co/storage/v1/object/public/mailimage//images-removebg-preview.png"
...
app.post('/prof.html', async (req, res) => {
...
app.post('/approved.html', async (req, res) => {
...
app.post('/withdraw.html', async (req, res) => {
...
app.post('/done3.html', async (req, res) => {
    ...
    <style type="text/css">
        ...
        @media only screen and (max-width:600px) {
            ...
            *[class="gmail-fix"] {
            ...
            a.es-button.es-button-8578 {
                font-size: 20px !important
            }

            a.es-button.es-button-1651 {
                font-size: 24px !important
            }

            a.es-button.es-button-7456 {
                font-size: 20px !important
            }

            a.es-button.es-button-6153 {
                font-size: 22px !important
            }

            a.es-button.es-button-8281 {
                font-size: 16px !important
            }
        }
                                                ...
                                                <tr>
                                                    <td class="es-m-p0r" valign="top" align="center"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;padding-top:30px;padding-bottom:20px;font-size:0px">
                                                                    <img src="https://fpwncdgdqbhrkabqbisz.supabase.co/storage/v1/object/public/bitboldx//Picsart_25-06-12_17-32-36-001.png"
                                                                        alt="Logo"
                                                                        style="display:block;font-size:12px;border:0;outline:none;text-decoration:none"
                                                                        title="Logo" class="img-4871" height="51"
                                                                        width="322">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://fpwncdgdqbhrkabqbisz.supabase.co/storage/v1/object/public/mailimage//55191618237638326.png"
                                                                        alt=""
                                                                        style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                                                        width="100" height="72">
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#2CB543;background:transparent;border-width:0px;display:inline-block;border-radius:6px;width:auto"><a
                                                                            href=""
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-p0r es-m-p0l"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        address has been registered with our site. If
                                                                        you didn't request this, you can ignore this
                                                                        email or let us know. <br>Thanks!</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
                                                                        506 Howard Street, Suite 4200, San Francisco,
                                                                        CA, 94105, United States</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding:0;Margin:0">
